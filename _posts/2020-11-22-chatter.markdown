...
There are tools we can use to reinforce this expectation. I like donut.ai as it creates random pairings, facilitates scheduling, provides helpful nudges, and shares stats on usage to reinforce that social proof point - everyone else is doing it.
